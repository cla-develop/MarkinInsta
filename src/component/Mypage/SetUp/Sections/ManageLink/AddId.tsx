...
import WebViewModal from '../../../../SignIn/LinkChannel/InstaWebView/WebViewModal';
// import {useNavigation} from '@react-navigation/native';
// import appLogo from '../../../images/appLogo.png';
// import GoogleWebview from './GoogleLogin/GoogleWebview';
import AsyncStorage from '@react-native-async-storage/async-storage';
export default function AddId({navigation}: any) {
    ...
    const getToken = async () => {
      ...
      await axios({
        ...
        .then(response => {
          ...
          put(response.data.access_token, response.data.user_id);
        })
        .catch(err => {
          console.log(err);
        });
  ...
  const put = (ac, id) => {
    axios({
      ...
      .catch(error => {
        // 오류발생시 실행
        console.log(error.data.message + 'errror');
      });
  };
