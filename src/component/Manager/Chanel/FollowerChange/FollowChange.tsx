...
export default function FollowChange(props: any) {
  ...
  return (
    <View style={styles.allView}>
      ...
      <View
        ...
        <View style={{width: '70%'}}>
          <Text style={styles.TopText}>팔로우 변화 추이</Text>
        </View>
      </View>
        ...
        <View>
          <View style={{width: 310, flexDirection: 'row', marginTop: 10}}>
            <View style={{width: 100}}>
              <Text style={styles.purpleText}>총 팔로워</Text>
            </View>
          ...
          <View style={{width: 310, flexDirection: 'row', marginTop: 10}}>
            <View style={{width: 100}}>
              <Text style={styles.blackTextx}>팔로우</Text>
            </View>
            <View style={{width: 210}}>
              <Text style={[styles.blackTextx, {textAlign: 'right'}]}>2명</Text>
            </View>
          </View>
        </View>
      </View>
