    ...
    <GestureRecognizer
      ...
      <Modal
        ...
        <WebView
          // ref={webviewRef}
          source={{
            uri: 'https://instagram.com/oauth/authorize?client_id=3188330554823906&redirect_uri=https://www.markin-app.site/app/auth&scope=user_profile,user_media,instagram_graph_user_media&response_type=code',
          }}
